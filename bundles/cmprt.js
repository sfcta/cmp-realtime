...
var redefine = __webpack_require__(278);
var hide = __webpack_require__(47);
...
var $export = __webpack_require__(0);
$export($export.S, 'Object', { is: __webpack_require__(289) });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            params = 'select=cmp_segid,year,date,period,los_hcm85,avg_speed';
    ...
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            buildAggData = {};
            url = API_SERVER + aggdat_view + '?select=fac_typ,period,date,viz,metric';
            _context4.prev = 2;
            _context4.next = 5;
            return fetch(url);
